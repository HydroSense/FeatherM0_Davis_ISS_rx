...
static const __attribute__((progmem)) char RFM69_MODE_STRINGS[COUNT_RF69_MODES][8] = {
	"SLEEP",
	"STANDBY",
	"SYNTH",
	"RX",
...
#define DISCOVERY_MINGAP 70000L		// 70 milliseconds
#define DISCOVERY_GUARD  60000L		// 60 milliseconds
